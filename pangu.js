...
// let selectedText = ENTER.payload
// selectedText = pangu.spacingTextSync(selectedText)
// utools.copyText(selectedText)
// utools.simulateKeyboardTap("v", "ctrl")
let text = pangu.spacing("这是一段testing文本,直接node pangfu.js打开")
console.log(text)